...
import '../../team_auth/signup_auth/team_signup_view/team_signup_view.dart';
import '../../team_profile/team_profile.dart';
...
class TeamBottomNav extends StatefulWidget {
  const TeamBottomNav({super.key});

  @override
  State<TeamBottomNav> createState() => _TeamBottomNavState();
}

class _TeamBottomNavState extends State<TeamBottomNav> {
  int _currentIndex = 0;
  ...
  Future<void> _logout() async {
    ...
    Get.offAll(() => const TeamSignupView()); // Clears all previous routes
  }
