...
import '../team_login_controller/team_login_controller.dart';

class TeamLoginView extends StatelessWidget {
  const TeamLoginView({super.key});

  @override
  Widget build(BuildContext context) {
    final loginController = Get.put(TeamLoginController());
